  ...
  >
    ...
    <div class="row g-0">
      ...
      <div class="col-6">
        ...
        >
          <span class="svg-icon svg-icon-3x svg-icon-success mb-2">
            <ClientOnly><inline-svg src="/media/icons/duotune/finance/fin009.svg" /></ClientOnly>
          </span>
      ...
      <div class="col-6">
        ...
        >
          <span class="svg-icon svg-icon-3x svg-icon-success mb-2">
            <ClientOnly><inline-svg src="/media/icons/duotune/abstract/abs042.svg" /></ClientOnly>
          </span>
