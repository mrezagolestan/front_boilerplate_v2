    ...
    <div class="card-body pt-9 pb-0">
              ...
              <div class="d-flex flex-wrap">
                ...
                <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="fs-2 fw-bold" data-kt-countup="true" data-kt-countup-value="4500" data-kt-countup-prefix="$">
                      4,500$
                    </div>
                  </div>
                  <!--end::Number-->
                ...
                <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="fs-2 fw-bold" data-kt-countup="true" data-kt-countup-value="60" data-kt-countup-prefix="%">
                      60%
                    </div>
                  </div>
                  <!--end::Number-->
      ...
      <div class="d-flex overflow-auto h-55px">
        <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold flex-nowrap">
          <!--begin::Nav item-->
          <li class="nav-item">
            <NuxtLink to="/crafted/pages/profile/overview" class="nav-link text-active-primary me-6" active-class="active">
              Overview
            </NuxtLink>
          </li>
          <!--end::Nav item-->
          <!--begin::Nav item-->
          <li class="nav-item">
            <NuxtLink class="nav-link text-active-primary me-6" to="/crafted/pages/profile/projects" active-class="active">
              Projects
            </NuxtLink>
          </li>
          <!--end::Nav item-->
          <!--begin::Nav item-->
          <li class="nav-item">
            <NuxtLink class="nav-link text-active-primary me-6" to="/crafted/pages/profile/campaigns" active-class="active">
              Campaigns
            </NuxtLink>
          </li>
          <!--end::Nav item-->
          <!--begin::Nav item-->
          <li class="nav-item">
            <NuxtLink class="nav-link text-active-primary me-6" to="/crafted/pages/profile/documents" active-class="active">
              Documents
            </NuxtLink>
          </li>
          <!--end::Nav item-->
          <!--begin::Nav item-->
          <li class="nav-item">
            <NuxtLink class="nav-link text-active-primary me-6" to="/crafted/pages/profile/connections" active-class="active">
              Connections
            </NuxtLink>
          </li>
          <!--end::Nav item-->
          <!--begin::Nav item-->
          <li class="nav-item">
            <NuxtLink class="nav-link text-active-primary me-6" to="/crafted/pages/profile/activity" active-class="active">
              Activity
            </NuxtLink>
          </li>
          <!--end::Nav item-->
